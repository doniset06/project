...
public class SelectClass extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
        ...
        select.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (spinner.getSelectedItem().equals("IPA1")) {
                    ...
                    Intent i = new Intent(SelectClass.this, IPA1.class);
                    i.putExtra("mapel",mapel);
                    startActivity(i);
                }
                else if(spinner.getSelectedItem().equals("IPA2")){

                    Intent i = new Intent(SelectClass.this, IPA2.class);
                    i.putExtra("mapel",mapel);
                    startActivity(i);
                }
            }
